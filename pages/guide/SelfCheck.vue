<template>
    <div class="text-center pa-4">
        <v-btn @click="SelfCheckModal = true"> Open Dialog </v-btn>

        <v-dialog v-model="SelfCheckModal" width="100%">
            <v-card class="modalSelfCheck student-analysis px30 py20">
                <v-btn density="compact" variants="text" tile elevation="0" min-width="30" min-height="30" class="close px-0">
                    <i class="ico close_30 ico_size_lg" @click="SelfCheckModal = false"></i>
                </v-btn>
                                ...
                                <div class="achieve_box">
                                    ...
                                    <v-list variant="flat" class="pa-0" density="compact">
                                        <v-list-item-subtitle>
                                            주요단어 (fine, good, great, bad, morning, afternoon, evening, night) 및 해당 단어가 포함된
                                            문장을 읽고 쓸 수 있나요?
                                        </v-list-item-subtitle>
                                        <v-list-item-subtitle
