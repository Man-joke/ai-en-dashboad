<template>
    <!-- 영역별 학업 성취율 팝업 -->
    <v-dialog v-model="achievement" width="auto">
        <v-card class="dialog pda20" width="138rem" height="80rem">
            <div class="dialog_header">
                ...
                <v-btn class="icon_close" @click="achievement = false"><i class="ico close_30 ico_size_lg"></i></v-btn>
            </div>
            <div class="dialog_body">
                ...
                <div class="chart_radar">
                    <ChartRadar :chartData="chartData" />
                    <!-- !NOTE 차트 라벨부분 입니다.-->
                    <div class="chart-bar">
                        <div class="use-word"><span class="bullet color-1"></span><p>김영철 학생</p></div>
                        <div class="use-word"><span class="bullet color-2"></span><p>반 평균</p></div>
                        <div class="use-word"><span class="bullet color-3"></span><p>지역 평균</p></div>
                    </div>
                    <!-- // 차트 라벨부분 입니다. -->
                </div>
            </div>
